...
df.alldates <- readRDS(file.path(path.pns.staged_data, "candidate_dates.RData"))
...
# analytic dataset; refer to calc-candidate-dates.R to see how the 
# variable is.equal was constructed
...
zoom.part3 <- TRUE
zoom.part4 <- FALSE
source(file.path(path.pns.code, "construct_quit_dates", "create-zoomed-smoking-plots.R"))
