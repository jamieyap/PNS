...
load(file.path(path.breakfree.staged_data, "raw.pressdaystart.cc2.RData"))

# Create data frame from list
df.raw.pressdaystart.cc2 <- bind_rows(list.df.raw.pressdaystart.cc2)

# Clean up columns
df.raw.pressdaystart.cc2 <- df.raw.pressdaystart.cc2 %>%
...
# Save cleaned data
write.csv(df.raw.pressdaystart.cc2, 
          file.path(path.breakfree.output_data, "pressdaystart_cc2.csv"), 
          row.names=FALSE, na="")
