...
use.info <- "PUFFMARKER\\_SMOKING\\_EPISODE\\+PHONE" # timing of beginning of smoking episodes
...
puffmarker.zipfile.names <- list.files(file.path(path.input_data, use.study, folder.puffmarker_data))
...
# Write data
#------------------------------------------------------------------------------
write.csv(df, file.path(path.input_data, use.study, folder.puffmarker_unzipped, "puffmarker.smoking.episodes.csv"), row.names = FALSE)
