...
load(file.path(path.breakfree.staged_data, "raw.sleep.cc2.RData"))

# Create data frame from list
df.raw.sleep.cc2 <- bind_rows(list.df.raw.sleep.cc2)
...
df.raw.sleep.cc2 <- df.raw.sleep.cc2 %>%
...
# Save cleaned data
write.csv(df.raw.sleep.cc2, 
          file.path(path.breakfree.output_data, "sleep.cc2.csv"), 
          row.names=FALSE)
